...
export function processNoUiSliderStyles () {
  return gulp.src('nouislider/dist/nouislider.min.css')
...
export const processStylesWithNoUiSlider = gulp.parallel(processStyles, processNoUiSliderStyles);
